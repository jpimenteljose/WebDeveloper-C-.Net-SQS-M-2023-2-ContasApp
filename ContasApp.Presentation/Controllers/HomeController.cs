...
namespace ContasApp.Presentation.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        /// <summary>
        /// Método para capturar o SUBMIT POST da página
        /// </summary>
        [HttpPost]
        ...
        // método para gerar o conteúdo do campo de seleção do anos
        ...
        private List<object> ObterReceitasEDespesas(int mes, int ano)
        {
            ...
            // primeiro dia e o último dia do mês selecionado
        ...
        private List<object> ObterTotalCategorias(int mes, int ano)
        {
            ...
            // primeiro dia e último dia do mês selecionado
            var qtdDiasMes = DateTime.DaysInMonth(ano, mes);
            var dataInicio = new DateTime(ano, mes, 1);
            var dataFim = new DateTime(ano, mes, qtdDiasMes);
